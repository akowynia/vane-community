# How Vane-Community Works

This is a high level overview of how Vane-Community answers a question.
...
If you are integrating Vane-Community into another product, you can call `POST /api/search`.
